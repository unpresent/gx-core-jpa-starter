...
import ru.gx.core.periodic.PeriodicUUID;
...
public class PostgreSQLPeriodicUUIDJsonType implements UserType {
    @Override
    public int[] sqlTypes() {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws HibernateException {
        ...
        return mapper.readValue(rs.getString(names[0]), PeriodicUUID.class);
    }
    ...
    public Serializable disassemble(Object value) throws HibernateException {
        return (PeriodicUUID) this.deepCopy(value);
    }
